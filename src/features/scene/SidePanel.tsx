...
export function SidePanel({ 
  ...
  const coupleAnims = [
    ...
    { label: 'H1', icon: '👊', s: 'h1_hit_punches', r: 'h1_attack_punches' },
    { label: 'H2', icon: '👊', s: 'h2_attack_side_kicks', r: 'h2_hit_dodge' },
    { label: 'H4', icon: '👊', s: 'h4_attack_rising_kick', r: 'h4_hit_staggering' },
    { label: 'Ko1', icon: '😵', s: 'ko1_fall_to_ground_sprawl', r: 'ko1_attack_uppercut' },
    ...
    { label: 'S2', icon: '🥋', s: 's2_sparring_dodges01', r: 's2_sparring_kicks' },
    { label: 'S3', icon: '🥋', s: 's3_sparring_dodges02', r: 's3_sparring_reverse_kicks' },
    ...
    { label: 'T3', icon: '🤼', s: 't3_fall_shoulder_throw', r: 't3_attack_shoulder_throw' },
    { label: 'T4', icon: '🤼', s: 't4_fall_belly_to_back_slam', r: 't4_attack_knee_strike' },
