...
export const CHARACTERS: CharacterConfig[] = [
  ...
  { id: 'vivid', name: 'Vivid', path: 'media/lara_native.glb', pos: [50, 40, 110], rot: Math.PI / 2, variant: 'vivid', height: 173.4, sittingScenePath: 'media/sandbox/anims/anim_sitting_idle.glb', customIdleAnimPath: 'media/sandbox/anims/anim_sitting_idle.glb' },
  { id: 'xbot', name: 'Xbot', path: 'media/sandbox/Xbot_official.glb', pos: [250, 0, 500], rot: 0, variant: 'native', height: 173.4, isLara: false },
  { id: 'sabira', name: 'Sabira', path: 'media/lara_native.glb', pos: [100, 0, 370], rot: Math.atan2(158 - 100, 200 - 370), variant: 'sabira', height: 173.4, customIdleAnimPath: 'media/sandbox/anims/anim_snake_hip_hop_dance.glb', sittingScenePath: 'media/sandbox/anims/anim_snake_hip_hop_dance.glb' },
        ...
        if (enableBreastPhysics && breastChainRef.current.length > 0) {
          ...
          for (let step = 0; step < subSteps; step++) {
            ...
            for (const node of breastChainRef.current) {
              ...
              const next = new THREE.Vector3().copy(node.tipWorld).add(vel).addScaledVector(g, fixedDt * fixedDt);
