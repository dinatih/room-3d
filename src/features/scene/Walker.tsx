...
export const CHARACTERS: CharacterConfig[] = [
  ...
  { id: 'cha', name: 'Cha', path: 'media/lara_native.glb', pos: [30, 0, 151], rot: Math.PI / 2, variant: 'cha', height: 173.4, sittingScenePath: 'media/sandbox/anims/anim_sitting_laughing.glb', customIdleAnimPath: 'media/sandbox/anims/anim_sitting_laughing.glb' },
