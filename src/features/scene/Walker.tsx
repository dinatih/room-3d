...
export const CHARACTERS: CharacterConfig[] = [
  ...
  { id: 'sandra', name: 'Sandra', path: 'media/lara_native.glb', pos: [-400, 0, 0], rot: 0, variant: 'sandra', height: 173.4 },
  { id: 'rajaa', name: 'Rajaa', path: 'media/lara_native.glb', pos: [-450, 0, 0], rot: 0, variant: 'rajaa', height: 173.4 },
  {
