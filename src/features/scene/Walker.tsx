...
export const CHARACTERS: CharacterConfig[] = [
  ...
  { id: 'cha', name: 'Cha', path: 'media/lara_native.glb', pos: [85, 45, 272], rot: Math.PI / 2, variant: 'cha', height: 173.4, sittingScenePath: 'media/sandbox/anims/anim_sitting_laughing.glb', customIdleAnimPath: 'media/sandbox/anims/anim_sitting_laughing.glb' },
