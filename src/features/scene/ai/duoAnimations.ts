...
export const DUO_ANIMATIONS: DuoAnimationDef[] = [
  ...
  { id: 'double_leg_takedown', label: 'Double Leg Takedown', icon: '🤼', animA: 'animations/combat/anim_best_double_leg_takedown_victim.glb', animB: 'animations/combat/anim_best_double_leg_takedown_attacker.glb', dist: 0, rotA: Math.PI, rotB: 0, offsetA: [0, 0, 10], offsetB: [0, 0, 0], duration: 5.0 },
