...
const RAW_DUO_ANIMATIONS: RawDuoAnimationDef[] = [
  ...
  { id: 'cuddle_kiss', label: 'Sit Cuddle Kiss', icon: '😘', animA: 'miley-armature-cuddle-kiss-m', animB: 'miley-armature-cuddle-kiss-f', offsetB: [-20, 0, 10] },
  ...
  { id: 'sit-cuddle', label: 'Sit Cuddle Hug', icon: '🛋️', animA: 'miley-armature-sit-cuddle-hug-m', animB: 'miley-armature-sit-cuddle-hug-f', offsetB: [0, 0, 20] },
