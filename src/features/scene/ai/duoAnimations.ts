...
export const DUO_ANIMATIONS: DuoAnimationDef[] = [
  ...
  { id: 'd4', label: 'D4', icon: '🤺', animA: 'animations/combat/miley_armature_d4_attack_reverse_front_snap_kick.glb', animB: 'animations/combat/miley_armature_d4_dodge_roll_back.glb', dist: 120, duration: 3.5 },
  ...
  { id: 'p1', label: 'P1', icon: '😤', animA: 'animations/combat/miley_armature_p1_standoff_push_knockout.glb', animB: 'animations/combat/miley_armature_p1_standoff_block_straight_punch.glb', dist: 190, duration: 4.0 },
  { id: 'p2', label: 'P2', icon: '😤', animA: 'animations/poses_idles/miley_armature_p2_standoff_provokes_m1.glb', animB: 'animations/poses_idles/miley_armature_p2_standoff_provokes_m2.glb', dist: 300, duration: 4.0 },
  ...
  { id: 'slow_dance', label: 'Slow Dance', icon: '💃', animA: 'animations/dances/miley_armature_slow_dance_m.glb', animB: 'animations/dances/miley_armature_slow_dance_f.glb', dist: 0, offsetB: [0, 0, 40], duration: 8.0 },
  ...
  { id: 'farewell_kiss', label: 'Farewell Kiss', icon: '👋', animA: 'animations/emotes_gestures/miley_armature_farewell_kiss_m.glb', animB: 'animations/emotes_gestures/miley_armature_farewell_kiss_f.glb', dist: 70, duration: 6.0 },
  { id: 'date_bearhug', label: 'Date Bearhug', icon: '🐻', animA: 'animations/interactions/miley_armature_date_bearhug_m.glb', animB: 'animations/interactions/miley_armature_date_bearhug_f.glb', dist: 10, offsetB: [0, 0, 610], duration: 6.0 },
  { id: 'propose', label: 'Propose', icon: '💍', animA: 'animations/poses_idles/miley_armature_propose_f.glb', animB: 'animations/poses_idles/miley_armature_propose_m.glb', dist: 50, offsetB: [0, 0, 0], duration: 6.0 },
  ...
  { id: 'double_leg_takedown', label: 'Double Leg Takedown', icon: '🤼', animA: 'animations/combat/anim_best_double_leg_takedown_attacker.glb', animB: 'animations/combat/anim_best_double_leg_takedown_victim.glb', dist: 0, rotA: 0, rotB: Math.PI, offsetA: [0, 0, 0], offsetB: [0, 0, 250], duration: 5.0 },
  ...
  { id: 'taken_hostage', label: 'Prise d\'otage', icon: '🚨', animA: 'animations/interactions/anim_taken_hostage_victim.glb', animB: 'animations/interactions/anim_taken_hostage_villain.glb', dist: 0, duration: 5.0, offsetB: [0, 0, -80] },
