...
export const ZONES: Record<string, ZoneNode> = {
  ...
  Placard_Couloir: { id: 'Placard_Couloir', x: 200, z: 435 },
  Placard_SDB: { id: 'Placard_SDB', x: 100, z: 610 },
  ...
  Miroir_Sud: { id: 'Miroir_Sud', x: 160, z: 380 },
  
  Lit_Ouest: { id: 'Lit_Ouest', x: 120, z: 110 },
  Lit_Ouest_2: { id: 'Lit_Ouest_2', x: 120, z: 150 },
  Lit_Ouest_3: { id: 'Lit_Ouest_3', x: 120, z: 190 },
  Lit_Ouest_Couche: { id: 'Lit_Ouest_Couche', x: 74, z: 150 },
  
  Lit_Est: { id: 'Lit_Est', x: 230, z: 110 },
  Lit_Est_2: { id: 'Lit_Est_2', x: 230, z: 150 },
  Lit_Est_3: { id: 'Lit_Est_3', x: 230, z: 190 },
  Lit_Est_Couche: { id: 'Lit_Est_Couche', x: 270, z: 190 },
  
  Canape_Est: { id: 'Canape_Est', x: 270, z: -80 },
  Canape_Est_2: { id: 'Canape_Est_2', x: 270, z: -120 },
  Canape_Est_Allonge: { id: 'Canape_Est_Allonge', x: 270, z: -100 },
  
  Canape_Ouest: { id: 'Canape_Ouest', x: 100, z: -50 },
  Canape_Ouest_2: { id: 'Canape_Ouest_2', x: 100, z: -90 },
  
  Baignoire: { id: 'Baignoire', x: 120, z: -250 },
  Baignoire_Ouest: { id: 'Baignoire_Ouest', x: 80, z: -250 },
  Baignoire_Est: { id: 'Baignoire_Est', x: 160, z: -250 },
};
