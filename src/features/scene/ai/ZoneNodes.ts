...
export const ZONES: Record<string, ZoneNode> = {
  ...
  Toilette: { id: 'Toilette', x: 50, z: 500 }, // Devant les toilettes
  ...
  Placard_Couloir: { id: 'Placard_Couloir', x: 220, z: 435 },
  Placard_SDB: { id: 'Placard_SDB', x: 90, z: 590 },
  Congelateur: { id: 'Congelateur', x: 250, z: 320 },
  SDB_Drona_Ouest: { id: 'SDB_Drona_Ouest', x: 15, z: 530 },
  SDB_Drona_Est: { id: 'SDB_Drona_Est', x: 175, z: 530 },
  ...
  Canape_Est: { id: 'Canape_Est_2', x: 270, z: -80 },
  Canape_Est_2: { id: 'Canape_Est_3', x: 270, z: -140 },
  Canape_Est_Allonge: { id: 'Canape_Est_Allonge', x: 270, z: -80 },

  Canape_Ouest: { id: 'Canape_Ouest_2', x: 100, z: -60 },
  Canape_Ouest_2: { id: 'Canape_Ouest_3', x: 100, z: -100 },
...
export const ACTION_GO_TO_TOILET: AgentInstruction[] = [
  ...
  { type: 'INTERACT', animation: 'media/sandbox/anims/anim_shaking_hands_2.glb', duration: 4.0, rotY: 0 },
];
...
export const ACTIONS_BED_WEST: AgentInstruction[][] = [
  [
    ...
    { type: 'INTERACT', animation: 'media/sandbox/anims/anim_female_sitting_pose_1.glb', duration: 15.0, rotY: 0 }
  ],
  [
  ...
  [
    ...
    { type: 'INTERACT', animation: 'media/sandbox/anims/anim_sleeping_idle.glb', duration: 15.0, rotY: 0 }
  ]
];
...
export const ACTIONS_BED_EAST: AgentInstruction[][] = [
  [
    ...
    { type: 'INTERACT', animation: 'media/sandbox/anims/anim_female_sitting_pose_1.glb', duration: 15.0, rotY: Math.PI }
  ],
  [
  ...
  [
    ...
    { type: 'INTERACT', animation: 'media/sandbox/anims/anim_sleeping_idle.glb', duration: 15.0, rotY: Math.PI }
  ]
];
