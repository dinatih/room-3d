...
export const WAYPOINTS: Record<string, Waypoint> = {
  ...
  'west-neighbor-terrace':  { id: 'west-neighbor-terrace',  name: 'Terrasse Voisin Ouest',       x: -200, z: 100  },
  'garden-north':           { id: 'garden-north',           name: 'Jardin Nord (Contour)',       x: 200,  z: -460 },
  'outdoor-garden-east':    { id: 'outdoor-garden-east',    name: 'Cour Est (Contour)',          x: 400,  z: -460 },
  'east-neighbor-terrace':  { id: 'east-neighbor-terrace',  name: 'Terrasse Voisin Est',         x: 450,  z: -250 },
