...
const ACTIONS: Record<string, ActionDef> = {
  ...
  lampSdb:         { btnLabel: () => useSceneStore.getState().furniture.lampSdb ? 'Éteindre SDB' : 'Allumer SDB', toggleKey: 'lampSdb' },
  lampCouloir:     { btnLabel: () => useSceneStore.getState().furniture.lampCouloir ? 'Éteindre Couloir' : 'Allumer Couloir', toggleKey: 'lampCouloir' },
