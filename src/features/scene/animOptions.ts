...
export const WALKER_ANIM_OPTIONS = [
  ...
  { value: "miley/_Emote_F", label: "_Emote_F (genaiguy)" },
  { value: "miley/_Talk_F", label: "_Talk_F (genaiguy)" },
  { value: "miley/Idle01_F", label: "Idle01_F (genaiguy)" },
  { value: "miley/Idle02_F", label: "Idle02_F (genaiguy)" },
  { value: "miley/Idle03_F", label: "Idle03_F (genaiguy)" },
  { value: "miley/Posing_F", label: "Posing_F (genaiguy)" },
  { value: "miley/Walk_F", label: "Walk_F (genaiguy)" },
  { value: "miley/Catwalk_end", label: "Catwalk_end (genaiguy)" },
  { value: "miley/Catwalk_loop", label: "Catwalk_loop (genaiguy)" },
  { value: "miley/Catwalk_start", label: "Catwalk_start (genaiguy)" },
  { value: "miley/Walk relaxed_end", label: "Walk relaxed_end (genaiguy)" },
  { value: "miley/Walk relaxed_loop", label: "Walk relaxed_loop (genaiguy)" },
  { value: "miley/Walk relaxed_start", label: "Walk relaxed_start (genaiguy)" },
  { value: "miley/Air dance", label: "Air dance (genaiguy)" },
  { value: "miley/Change pose", label: "Change pose (genaiguy)" },
  { value: "miley/Dance graceful", label: "Dance graceful (genaiguy)" },
  { value: "miley/Sit talk", label: "Sit talk (genaiguy)" },
  { value: "miley/Stand talk", label: "Stand talk (genaiguy)" },
  { value: "miley/Stand to sit", label: "Stand to sit (genaiguy)" },
  { value: "miley/Pick_Throw_F1", label: "Pick_Throw_F1 (genaiguy)" },
  { value: "miley/Chaos_Duck_Cover_F1", label: "Chaos_Duck_Cover_F1 (genaiguy)" },
  { value: "miley/Ambitious Speech", label: "Ambitious Speech (genaiguy)" },
  { value: "miley/Elegant Walk_1S", label: "Elegant Walk_1S (genaiguy)" },
  { value: "miley/Elegant Walk_2L", label: "Elegant Walk_2L (genaiguy)" },
  { value: "miley/Elegant Walk_3E", label: "Elegant Walk_3E (genaiguy)" },
  { value: "miley/Sit Look Up & Laugh", label: "Sit Look Up & Laugh (genaiguy)" },
  { value: "miley/Wand Attack", label: "Wand Attack (genaiguy)" },
  { value: "miley/Aerobic Dance", label: "Aerobic Dance (genaiguy)" },
  { value: "miley/Against_Wall_Turn_L_to_SneakWalk", label: "Against_Wall_Turn_L_to_SneakWalk (genaiguy)" },
  { value: "miley/B09_Hold_Gun_Turn90_R", label: "B09_Hold_Gun_Turn90_R (genaiguy)" },
  { value: "miley/B083_RunToBlastB", label: "B083_RunToBlastB (genaiguy)" },
  { value: "miley/C08_Low_Hold_Gun_Turn180_L", label: "C08_Low_Hold_Gun_Turn180_L (genaiguy)" },
  { value: "miley/Cc02_SideShoot", label: "Cc02_SideShoot (genaiguy)" },
  { value: "miley/Crouch_Walk_R_AgainstWall", label: "Crouch_Walk_R_AgainstWall (genaiguy)" },
  { value: "miley/E07_Low_Hide_Wall_Reload", label: "E07_Low_Hide_Wall_Reload (genaiguy)" },
  { value: "miley/F_H_MageSpellCast_05", label: "F_H_MageSpellCast_05 (genaiguy)" },
  { value: "miley/Protest_Inplace_Loop_F2", label: "Protest_Inplace_Loop_F2 (genaiguy)" },
  { value: "miley/Sensual_Dance_01", label: "Sensual_Dance_01 (genaiguy)" },
  { value: "miley/Sensual_Dance_02", label: "Sensual_Dance_02 (genaiguy)" },
  { value: "miley/Sensual_Dance_03", label: "Sensual_Dance_03 (genaiguy)" },
  { value: "miley/16_Taunt Beside Opponent", label: "16_Taunt Beside Opponent (genaiguy)" },
  { value: "miley/01_Rightward Movement After Dodge", label: "01_Rightward Movement After Dodge (genaiguy)" },
  { value: "miley/02_Leftward Movement After Dodge", label: "02_Leftward Movement After Dodge (genaiguy)" },
  { value: "miley/03_Side Movement and Head Strikes", label: "03_Side Movement and Head Strikes (genaiguy)" },
  { value: "miley/04_Large Step Right Dodge", label: "04_Large Step Right Dodge (genaiguy)" },
  { value: "miley/05_Large Step Left Dodge", label: "05_Large Step Left Dodge (genaiguy)" },
  { value: "miley/06_Head Strike After Dodge", label: "06_Head Strike After Dodge (genaiguy)" },
  { value: "miley/07_Head Sway and Leftward Dodge", label: "07_Head Sway and Leftward Dodge (genaiguy)" },
  { value: "miley/08_Head Sway and Rightward Dodge", label: "08_Head Sway and Rightward Dodge (genaiguy)" },
  { value: "miley/09_Dodge with Belly Strikes", label: "09_Dodge with Belly Strikes (genaiguy)" },
  { value: "miley/10_Dance-Like Sidestep", label: "10_Dance-Like Sidestep (genaiguy)" },
  { value: "miley/11_Head Combo with Belly Strike", label: "11_Head Combo with Belly Strike (genaiguy)" },
  { value: "miley/08_Angry Walk", label: "08_Angry Walk (genaiguy)" },
  { value: "miley/26_Drunk Walk", label: "26_Drunk Walk (genaiguy)" },
  { value: "miley/32_Groove Walk ", label: "32_Groove Walk  (genaiguy)" },
  { value: "miley/41_Provocative Walk", label: "41_Provocative Walk (genaiguy)" },
  { value: "miley/Routine 05", label: "Routine 05 (genaiguy)" },
  { value: "miley/Dougie", label: "Dougie (genaiguy)" },
  { value: "miley/Down 01", label: "Down 01 (genaiguy)" },
  { value: "miley/Argument_Bossy_F", label: "Argument_Bossy_F (genaiguy)" },
  { value: "miley/Chat_Calm_F", label: "Chat_Calm_F (genaiguy)" },
  { value: "miley/Chat_Relax_F", label: "Chat_Relax_F (genaiguy)" },
  { value: "miley/MovingChat_Strolling_F", label: "MovingChat_Strolling_F (genaiguy)" },
  { value: "miley/MovingDiscuss_Calm_F", label: "MovingDiscuss_Calm_F (genaiguy)" },
  { value: "miley/Sneeze", label: "Sneeze (genaiguy)" },
  { value: "miley/Taunt Chest Pound", label: "Taunt Chest Pound (genaiguy)" },
  { value: "miley/Taunt Dance Loop", label: "Taunt Dance Loop (genaiguy)" },
  { value: "miley/Invite Fight", label: "Invite Fight (genaiguy)" },
  { value: "miley/Admire Bow Down", label: "Admire Bow Down (genaiguy)" },
  { value: "miley/Admire Draw Heart", label: "Admire Draw Heart (genaiguy)" },
  { value: "miley/Thanks Lady Bow", label: "Thanks Lady Bow (genaiguy)" },
  { value: "miley/Cheer Feminine Jump", label: "Cheer Feminine Jump (genaiguy)" },
  { value: "miley/Lose Shout", label: "Lose Shout (genaiguy)" },
  { value: "miley/B1_Attack_Back Somersault Flip", label: "B1_Attack_Back Somersault Flip (genaiguy)" },
  { value: "miley/B1_Fall_Kicked Knockout", label: "B1_Fall_Kicked Knockout (genaiguy)" },
  { value: "miley/B2_Attack_Front Kick", label: "B2_Attack_Front Kick (genaiguy)" },
  { value: "miley/B3_Attack_Reverse Turning Kick", label: "B3_Attack_Reverse Turning Kick (genaiguy)" },
  { value: "miley/D1_Attack_Arms Block", label: "D1_Attack_Arms Block (genaiguy)" },
  { value: "miley/D1_Dodge_Sideways", label: "D1_Dodge_Sideways (genaiguy)" },
  { value: "miley/D3_Dodge_Duck", label: "D3_Dodge_Duck (genaiguy)" },
  { value: "miley/D4_Attack_Reverse & Front Snap Kick", label: "D4_Attack_Reverse & Front Snap Kick (genaiguy)" },
  { value: "miley/D4_Dodge_Roll Back", label: "D4_Dodge_Roll Back (genaiguy)" },
  { value: "miley/H1_Attack_Punches", label: "H1_Attack_Punches (genaiguy)" },
  { value: "miley/H1_Hit_Punches", label: "H1_Hit_Punches (genaiguy)" },
  { value: "miley/H2_Attack_Side Kicks", label: "H2_Attack_Side Kicks (genaiguy)" },
  { value: "miley/H2_Hit_Dodge", label: "H2_Hit_Dodge (genaiguy)" },
  { value: "miley/H3_Hit_Jumping Snap Kick", label: "H3_Hit_Jumping Snap Kick (genaiguy)" },
  { value: "miley/H4_Attack_Rising Kick", label: "H4_Attack_Rising Kick (genaiguy)" },
  { value: "miley/H4_Hit_Staggering", label: "H4_Hit_Staggering (genaiguy)" },
  { value: "miley/H5_Hit_Dodge_Hug Belly", label: "H5_Hit_Dodge_Hug Belly (genaiguy)" },
  { value: "miley/P1_Standoff_Block & Straight Punch", label: "P1_Standoff_Block & Straight Punch (genaiguy)" },
  { value: "miley/P1_Standoff_Push & Knockout", label: "P1_Standoff_Push & Knockout (genaiguy)" },
  { value: "miley/P2_Standoff_Provokes_M1", label: "P2_Standoff_Provokes_M1 (genaiguy)" },
  { value: "miley/P2_Standoff_Provokes_M2", label: "P2_Standoff_Provokes_M2 (genaiguy)" },
  { value: "miley/S1_Sparring_Punch_M1", label: "S1_Sparring_Punch_M1 (genaiguy)" },
  { value: "miley/S1_Sparring_Punch_M2", label: "S1_Sparring_Punch_M2 (genaiguy)" },
  { value: "miley/S2_Sparring_Dodges01", label: "S2_Sparring_Dodges01 (genaiguy)" },
  { value: "miley/S2_Sparring_Kicks", label: "S2_Sparring_Kicks (genaiguy)" },
  { value: "miley/S3_Sparring_Dodges02", label: "S3_Sparring_Dodges02 (genaiguy)" },
  { value: "miley/S3_Sparring_Reverse kicks", label: "S3_Sparring_Reverse kicks (genaiguy)" },
  { value: "miley/S4_Sparring_Double Kicks_M1", label: "S4_Sparring_Double Kicks_M1 (genaiguy)" },
  { value: "miley/S4_Sparring_Double Kicks_M2", label: "S4_Sparring_Double Kicks_M2 (genaiguy)" },
  { value: "miley/S5_Sparring_Block Hit", label: "S5_Sparring_Block Hit (genaiguy)" },
  { value: "miley/S5_Sparring_Block Kick", label: "S5_Sparring_Block Kick (genaiguy)" },
  { value: "miley/T1_Attack_Thrown", label: "T1_Attack_Thrown (genaiguy)" },
  { value: "miley/T1_Hit_Suplex", label: "T1_Hit_Suplex (genaiguy)" },
  { value: "miley/T3_Attack_Shoulder Throw", label: "T3_Attack_Shoulder Throw (genaiguy)" },
  { value: "miley/T3_Fall_Shoulder Throw", label: "T3_Fall_Shoulder Throw (genaiguy)" },
  { value: "miley/T4_Attack_Knee Strike", label: "T4_Attack_Knee Strike (genaiguy)" },
  { value: "miley/T4_Fall_Belly to Back Slam", label: "T4_Fall_Belly to Back Slam (genaiguy)" },
  { value: "miley/T5_Attack_Headlock Takeover", label: "T5_Attack_Headlock Takeover (genaiguy)" },
  { value: "miley/T5_Fall_Headlock Takeover", label: "T5_Fall_Headlock Takeover (genaiguy)" },
  { value: "miley/F2_Attack_Straight Punch02", label: "F2_Attack_Straight Punch02 (genaiguy)" },
  { value: "miley/F2_Fall to Ground_Face Up01", label: "F2_Fall to Ground_Face Up01 (genaiguy)" },
  { value: "miley/G1_Getup_Kip Up", label: "G1_Getup_Kip Up (genaiguy)" },
  { value: "miley/G2_Getup_Handstand Kip Up", label: "G2_Getup_Handstand Kip Up (genaiguy)" },
  { value: "miley/KO1_Attack_Uppercut", label: "KO1_Attack_Uppercut (genaiguy)" },
  { value: "miley/KO1_Fall to Ground_Sprawl", label: "KO1_Fall to Ground_Sprawl (genaiguy)" },
  { value: "miley/KO2_Attack_Hood Kicks", label: "KO2_Attack_Hood Kicks (genaiguy)" },
  { value: "miley/KO2_Fall to Ground_Axel Down", label: "KO2_Fall to Ground_Axel Down (genaiguy)" },
  { value: "miley/KO3_Attack_Hammer Fist", label: "KO3_Attack_Hammer Fist (genaiguy)" },
  { value: "miley/KO3_Fall to Ground_Side Up02", label: "KO3_Fall to Ground_Side Up02 (genaiguy)" },
  { value: "miley/DoubleBlade_Bladesurge_M", label: "DoubleBlade_Bladesurge_M (genaiguy)" },
  { value: "miley/DoubleBlade_BroadswordPlay_M", label: "DoubleBlade_BroadswordPlay_M (genaiguy)" },
  { value: "miley/DoubleBlade_Duel_F", label: "DoubleBlade_Duel_F (genaiguy)" },
  { value: "miley/DoubleBlade_Rising_F", label: "DoubleBlade_Rising_F (genaiguy)" },
  { value: "miley/DoubleDagger_Rapid_F", label: "DoubleDagger_Rapid_F (genaiguy)" },
  { value: "miley/Axe_Stand_M", label: "Axe_Stand_M (genaiguy)" },
  { value: "miley/Axe_Upright_M", label: "Axe_Upright_M (genaiguy)" },
  { value: "miley/Blade_Blast_M", label: "Blade_Blast_M (genaiguy)" },
  { value: "miley/Blade_WrapAround_M", label: "Blade_WrapAround_M (genaiguy)" },
  { value: "miley/LivingRoom_Swing_M", label: "LivingRoom_Swing_M (genaiguy)" },
  { value: "miley/Fall Down_F", label: "Fall Down_F (genaiguy)" },
  { value: "miley/R15_Staunch Bleeding_M", label: "R15_Staunch Bleeding_M (genaiguy)" },
  { value: "miley/Agent Cartwheel Landing", label: "Agent Cartwheel Landing (genaiguy)" },
  { value: "miley/Agent Flip Over", label: "Agent Flip Over (genaiguy)" },
  { value: "miley/Agent Jump Down", label: "Agent Jump Down (genaiguy)" },
  { value: "miley/Agent Jump Landing", label: "Agent Jump Landing (genaiguy)" },
  { value: "miley/Agent Leap Landing", label: "Agent Leap Landing (genaiguy)" },
  { value: "miley/Agent Leap Over", label: "Agent Leap Over (genaiguy)" },
  { value: "miley/Agent Draw a Gun", label: "Agent Draw a Gun (genaiguy)" },
  { value: "miley/Agent Behind Wall", label: "Agent Behind Wall (genaiguy)" },
  { value: "miley/Agent Elbow Strike & Sweep Kick", label: "Agent Elbow Strike & Sweep Kick (genaiguy)" },
  { value: "miley/Agent Roll Forward", label: "Agent Roll Forward (genaiguy)" },
  { value: "miley/Agent Snap Kick", label: "Agent Snap Kick (genaiguy)" },
  { value: "miley/Couple Pop Dance_F", label: "Couple Pop Dance_F (genaiguy)" },
  { value: "miley/Couple Pop Dance_M", label: "Couple Pop Dance_M (genaiguy)" },
  { value: "miley/Energetic Dance_F", label: "Energetic Dance_F (genaiguy)" },
  { value: "miley/Energetic Dance_M", label: "Energetic Dance_M (genaiguy)" },
  { value: "miley/Slow Dance_F", label: "Slow Dance_F (genaiguy)" },
  { value: "miley/Slow Dance_M", label: "Slow Dance_M (genaiguy)" },
  { value: "miley/Date & BearHug_F", label: "Date & BearHug_F (genaiguy)" },
  { value: "miley/Date & BearHug_M", label: "Date & BearHug_M (genaiguy)" },
  { value: "miley/Farewell Kiss_F", label: "Farewell Kiss_F (genaiguy)" },
  { value: "miley/Farewell Kiss_M", label: "Farewell Kiss_M (genaiguy)" },
  { value: "miley/Tight Hug_M", label: "Tight Hug_M (genaiguy)" },
  { value: "miley/Cuddle Kiss_F", label: "Cuddle Kiss_F (genaiguy)" },
  { value: "miley/Cuddle Kiss_M", label: "Cuddle Kiss_M (genaiguy)" },
  { value: "miley/Eye-to-Eye Hug & Kiss_F", label: "Eye-to-Eye Hug & Kiss_F (genaiguy)" },
  { value: "miley/Eye-to-Eye Hug & Kiss_M", label: "Eye-to-Eye Hug & Kiss_M (genaiguy)" },
  { value: "miley/Propose_F", label: "Propose_F (genaiguy)" },
  { value: "miley/Propose_M", label: "Propose_M (genaiguy)" },
  { value: "miley/Sit Cuddle Hug_F", label: "Sit Cuddle Hug_F (genaiguy)" },
  { value: "miley/Sit Cuddle Hug_M", label: "Sit Cuddle Hug_M (genaiguy)" },
  { value: "miley/DanceToMusic_F", label: "DanceToMusic_F (genaiguy)" },
  { value: "miley/MusicalPlaytime_F", label: "MusicalPlaytime_F (genaiguy)" },
  { value: "miley/FirstReact_JogToRun_F", label: "FirstReact_JogToRun_F (genaiguy)" },
  { value: "miley/Panic_CarryGirl_F", label: "Panic_CarryGirl_F (genaiguy)" },
  { value: "miley/Panic_WalkToRun_F03", label: "Panic_WalkToRun_F03 (genaiguy)" },
  { value: "miley/UpDown_WalkToRunStairs_F", label: "UpDown_WalkToRunStairs_F (genaiguy)" },
  { value: "miley/Basic_Sing Aggressively", label: "Basic_Sing Aggressively (genaiguy)" },
  { value: "miley/Groove_Jump Up", label: "Groove_Jump Up (genaiguy)" },
