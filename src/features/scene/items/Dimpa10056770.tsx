...
/**
 * DIMPA sac de rangement, transparent, 65x22x65 cm
 * Price: 3,50
...
export function Dimpa10056770({ onSize, ...props }: SceneItemProps) {
  const { scene } = useGLTFClone('/media/glb/ikea-official/Dimpa10056770.glb');
...
useGLTF.preload('/media/glb/ikea-official/Dimpa10056770.glb');
