...
const GLB        = 'media/glb/ikea-official/METOD Rangement mural blanc 40x37x60 cm.glb';
const DOOR_GLB   = 'media/glb/ikea-official/RINGHULT Porte brillant gris clair 40x60 cm.glb';
