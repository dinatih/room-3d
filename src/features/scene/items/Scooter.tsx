/**
 * Scooter.tsx — Trottinette Xiaomi 4 (GLB media/glb/xiaomi_electric_scooter_4.glb).
...
export function Scooter({ onSize }: SceneItemProps) {
  const { scene } = useGLTFClone('media/glb/xiaomi_electric_scooter_4.glb');
...
useGLTF.preload('media/glb/xiaomi_electric_scooter_4.glb');
