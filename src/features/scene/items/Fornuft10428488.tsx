...
/**
 * FÖRNUFT couteau, acier inoxydable, 21 cm
 * Price: 2,49
...
export function Fornuft10428488({ onSize, ...props }: SceneItemProps) {
  const { scene } = useGLTFClone('/items/fornuft10428488/Fornuft10428488.glb');
...
useGLTF.preload('/items/fornuft10428488/Fornuft10428488.glb');
