...
const GLB        = 'items/metod rangement blanc 40x60x80 cm/METOD Rangement blanc 40x60x80 cm.glb';
const DOOR_GLB   = 'items/ringhult porte brillant gris clair 40x80 cm/RINGHULT Porte brillant gris clair 40x80 cm.glb';
