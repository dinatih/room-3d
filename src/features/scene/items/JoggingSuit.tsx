/**
 * JoggingSuit.tsx — Jogging suit (GLB characters/clothing/realistic_human_cloths.glb).
...
export function JoggingSuit({ onSize }: SceneItemProps) {
  const { scene } = useGLTFClone('characters/clothing/realistic_human_cloths.glb');
...
useGLTF.preload('characters/clothing/realistic_human_cloths.glb');
