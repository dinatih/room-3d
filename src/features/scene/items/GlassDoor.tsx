...
export function GlassDoor({ actionState, onSize }: SceneItemProps) {
  ...
  return (
    <group position={[0, -GLASS_TOP / 2, 0]}>
      ...
      {/* Montant gauche */}
      <mesh position={[-W_TOTAL / 2 + FRAME / 2, 25 + 200 / 2, 0]} castShadow receiveShadow>
      ...
      <mesh position={[0, 225 - FRAME / 2, 0]} castShadow receiveShadow>
        <boxGeometry args={[W_INNER, FRAME, FRAME_D_V2]} />{pvcMat}
      </mesh>
      {/* Traverse basse (s'emboîte entre les montants) */}
      <mesh position={[0, 25 + FRAME / 2, 0]} castShadow receiveShadow>
        <boxGeometry args={[W_INNER, FRAME, FRAME_D_V2]} />{pvcMat}
      </mesh>
      ...
      <mesh position={[-W_INNER / 2 - 0.5, 25 + 200 / 2, -4]} castShadow receiveShadow>
      ...
      <group position={[0, 225 + BOX_H / 2, BOX_D / 2]}>
        ...
        <mesh position={[0, -BOX_H / 2 + 0.5, BOX_D / 2 + 0.05]} castShadow receiveShadow>
