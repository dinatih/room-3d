...
function RocketMesh() {
  const { scene } = useGLTFClone('media/plane_rocket.glb');
...
function CometMesh() {
  const gltf = useGLTF('media/plane_comet.glb');
...
useGLTF.preload('media/plane_rocket.glb');
useGLTF.preload('media/plane_comet.glb');
