...
`;
    ...
    if (fs.existsSync(inventoryPath)) {
        ...
        const newEntry = `
  { id: '${componentName.toLowerCase()}', name: "${productData.name.replace(/"/g, '\\"')}", brand: 'IKEA', category: 'furniture', qty: 1, dims: { w: ${productData.w}, d: ${productData.d}, h: ${productData.h} }, glbPath: 'media/glb/ikea-official/${glbFileName}', photos: [${photoPaths}], url: '${url}', price: '${productData.price}', description: "${productData.desc.replace(/"/g, '\\"')}", tags: ['ikea'] },`;
