...
(async () => {
  ...
  try {
    console.log('1. Navigating to http://localhost:5173/red-lara.html...');
    await page.goto('http://localhost:5173/red-lara.html', { waitUntil: 'domcontentloaded', timeout: 15000 });
