...
IN_DIR = "/home/dinatih/Projects/room-3d/sources_backup/female_basic_locomotion"
...
if __name__ == "__main__":
    ...
    for fbx_path in fbx_files:
        ...
        # Create a clean name like "left_strafe" from "left strafe.fbx"
        name = basename.replace(".fbx", "").replace(" ", "_").replace("(", "").replace(")", "").lower()
