...
export const INVENTORY = [
  ...
  { id: 'drona-box',              name: 'Boîte Drona',                    brand: 'IKEA',    category: 'storage',   qty: 25,dims: { w: 33,   d: 38,   h: 33  }, scenePos: { x: 150,  z: 200  }, notes: 'Réparties dans les Kallax' },
  ...
  { id: 'smorkull-chair',         name: 'Chaise de bureau Smörkull',      brand: 'IKEA',    category: 'furniture', qty: 1, dims: { w: 67,   d: 67,   h: 128 }, scenePos: { x: 50,   z: 151  }, notes: 'Rouge, hauteur 128cm GLB' },
  { id: 'sunnersta',              name: 'Desserte SUNNERSTA',             brand: 'IKEA',    category: 'furniture', qty: 1, dims: { w: 36,   d: 56,   h: 90  }, scenePos: { x: 282,  z: 300  }, notes: 'Roulante, têtes de mannequin dessus' },
  ...
  { id: 'viggja',                 name: 'Desserte VIGGJA',                brand: 'IKEA',    category: 'furniture', qty: 1, dims: { w: 37,   d: 50,   h: 74  }, scenePos: { x: 100,  z: -125 }, notes: 'Jardin, à côté canapé ouest' },
  ...
  { id: 'folding-chair',          name: 'Chaise pliante VIHALS',          brand: 'IKEA',    category: 'furniture', qty: 1, dims: { w: 45,   d: 50,   h: 80  }, scenePos: { x: -50,  z: 350  }, notes: 'Rouge, jardin' },
  ...
  { id: 'laptop',                 name: 'Framework Laptop 13"',            brand: 'Framework',category: 'tech',     qty: 1, dims: { w: 29.7, d: 22.8, h: 1.55}, scenePos: { x: 200,  z: 170  }, notes: 'AMD Ryzen AI 5 340, 2256×1504 13", écran 110° ouvert, bureau 2' },
  ...
  { id: 'scooter',                name: 'Trottinette électrique Xiaomi 4', brand: 'Xiaomi',  category: 'tech',      qty: 1, dims: { w: 50,   d: 50,   h: 113 }, scenePos: { x: 282,  z: 460  }, notes: 'Guidon déplié, couloir' },
  ...
  { id: 'pizza-oven',             name: 'Four à pizza',                    brand: '',        category: 'kitchen',   qty: 1, dims: { w: 20,   d: 20,   h: 19  }, scenePos: { x: -20,  z: 300  }, notes: 'Sur Kallax cuisine' },
  ...
  // ── CLOTHING ─────────────────────────────
  { id: 'mackapar',               name: 'Portant MACKAPÄR',                brand: 'IKEA',    category: 'clothing',  qty: 1, dims: { w: 77,   d: 32,   h: 200 }, scenePos: { x: 32,   z: 300  }, notes: 'Avec 2 vêtements + casquette' },
  { id: 'jumpsuit',               name: 'Combinaison mécanicien',          brand: '',        category: 'clothing',  qty: 1, dims: { w: 40,   d: 40,   h: 150 }, scenePos: { x: 32,   z: 300  }, notes: 'Rouge, suspendue' },
  { id: 'salopette',              name: 'Salopette noire',                 brand: '',        category: 'clothing',  qty: 1, dims: { w: 6,    d: 40,   h: 150 }, scenePos: { x: 42,   z: 300  }, notes: 'Noire, suspendue' },
  { id: 'baseball-cap',           name: 'Casquette baseball',              brand: '',        category: 'clothing',  qty: 3, dims: { w: 25,   d: 20,   h: 15  }, scenePos: { x: 40,   z: 300  }, notes: '3 casquettes rouges sur portant' },
  { id: 'business-suit',          name: 'Costume',                         brand: '',        category: 'clothing',  qty: 1, dims: { w: 50,   d: 30,   h: 170 }, scenePos: { x: 150,  z: 200  }, notes: 'Sur walking man' },
  { id: 'realistic-cloths',       name: 'Tenue réaliste',                  brand: '',        category: 'clothing',  qty: 1, dims: { w: 40,   d: 40,   h: 170 }, scenePos: { x: 260,  z: -250 }, notes: 'Rouge, près baignoire' },
  { id: 'backpack',               name: 'Sac à dos',                       brand: '',        category: 'clothing',  qty: 1, dims: { w: 30,   d: 20,   h: 50  }, scenePos: { x: 10,   z: 236  }, notes: 'Rouge, mur A niche' },
  { id: 'sneaker',                name: 'Sneakers',                        brand: '',        category: 'clothing',  qty: 2, dims: { w: 30,   d: 12,   h: 12  }, scenePos: { x: 5,    z: 240  }, notes: 'Paire, mur A niche' },
  ...
  { id: 'air-performer',          name: 'Dyson Air Performer',             brand: 'Dyson',   category: 'decor',     qty: 1, dims: { w: 20,   d: 20,   h: 100 }, scenePos: { x: 150,  z: 200  }, notes: 'Ventilateur/purificateur' },
  { id: 'lamp-ola',               name: 'Lampe OLA',                       brand: 'IKEA',    category: 'decor',     qty: 1, dims: { w: 30,   d: 30,   h: 120 }, scenePos: { x: 150,  z: 200  }, notes: 'Sur pied, toggle ON/OFF' },
  { id: 'altappen-lantern',       name: 'Lanterne ALTAPPEN',               brand: 'IKEA',    category: 'decor',     qty: 1, dims: { w: 22,   d: 22,   h: 35  }, scenePos: { x: 100,  z: -125 }, notes: 'Jardin, desserte Viggja' },
  { id: 'potted-palm',            name: 'Palmier en pot',                  brand: '',        category: 'decor',     qty: 1, dims: { w: 60,   d: 60,   h: 150 }, scenePos: { x: 100,  z: -150 }, notes: 'Jardin, entre canapé et desserte' },
];
