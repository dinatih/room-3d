...
print_rotation('spine')
print_rotation('spine.001')
print_rotation('spine.002')
print_rotation('spine.003')
print_rotation('spine.004')
print_rotation('shoulder.L')
print_rotation('upper_arm.L')
